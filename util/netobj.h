...
int obj_to_net(const NetObjTable *types, gcp::control::NetBuf *net, int id, void *obj);
int net_to_obj(const NetObjTable *types, gcp::control::NetBuf *net, int id, void *obj);
...
typedef unsigned int NetMask;
typedef unsigned int NetUint;
